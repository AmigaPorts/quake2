...
{
  if (!stricmp(var_name,"ahi_speed")) return &ahi_speed;
  else if (!stricmp(var_name,"ahi_channels")) return &ahi_channels;
  else if (!stricmp(var_name,"ahi_bits")) return &ahi_bits;
  else if (!stricmp(var_name,"s_khz")) return &s_khz;
