...
cvar_t  *r_cullworld;
cvar_t  *gl_ext_clip_volume_hint; //aliasmodel bounds
...
#ifdef AMIGA //surgeon: sorting for entities + other stuff
...
{ 
	...
	gl_ext_clip_volume_hint =  ri.Cvar_Get( "gl_ext_clip_volume_hint", "0", CVAR_ARCHIVE ); 
