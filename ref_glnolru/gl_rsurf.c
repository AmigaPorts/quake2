...
#ifndef AMIGA //moved because of entity state-sorting 
		GL_TexEnv( GL_MODULATE ); 
		qglEnable (GL_BLEND);
#endif 
	}
...
{ 
	...
	{
#ifdef AMIGA //surgeon: create vertexlighting
	int i;
...
#ifdef AMIGA // from glquake - colinear vertex removal
...
#ifdef AMIGA //surgeon: add surf to vertexlighting
